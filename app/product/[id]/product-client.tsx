...
const products: Record<string, {
  ...
  "radiance-serum": {
    ...
    price: 68,
    originalPrice: null,
    image: "/velour-boutique/images/products/serum.jpg",
    sizes: ["30ml", "50ml"],
    ...
    howToUse: "Apply 3-4 drops to cleansed face and neck morning and evening. Gently pat into skin until absorbed. Follow with your favorite Velour moisturizer. For best results, use consistently for 4-6 weeks.",
  ...
  "hydra-cream": {
    ...
    price: 54,
    originalPrice: null,
    image: "/velour-boutique/images/products/moisturizer.jpg",
    sizes: ["50ml", "100ml"],
  ...
  "gentle-cleanser": {
    ...
    price: 38,
    originalPrice: 48,
    image: "/velour-boutique/images/products/cleanser.jpg",
    sizes: ["150ml", "250ml"],
  ...
  "renewal-oil": {
    ...
    price: 72,
    originalPrice: null,
    image: "/velour-boutique/images/products/oil.jpg",
    sizes: ["30ml", "50ml"],
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                ...
                <button
                 ...
                 onClick={() => toast.success("Processing purchase", { description: "Redirecting to checkout..." })}>
                  Buy Now
                </button>
              </div>
